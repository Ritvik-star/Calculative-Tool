...
# setting up the tkinter window
        ...
        def check_pass():
    Calculation = user_entry.get()
            if Calculation == "arithmetic" or Calculation == "conversion" or Calculation == "IT" or Calculation == "GST":
        root.destroy()

        main = tkinter.Tk(className="calculator")
        main.geometry("250x400+300+300")
        main.title("Master Calculator")
        


        ws = main.winfo_screenwidth()
        wh = main.winfo_screenheight()
        ...
        main.geometry(data)    #it can take 4 arguments(widthxheight+x+y) 
